...
enum class TEXTURE_ASSET_ID
{
	...
	LABEL_BUSLOOP = LABEL_NEST + 1,
	LABEL_BEACH = LABEL_BUSLOOP + 1,
	...
	BUSLOOP_BACKGROUND = LIB_COLL5 + 1,
	BUSLOOP_BUS = BUSLOOP_BACKGROUND + 1,
	TBC = BUSLOOP_BUS + 1,
	...
	NEST_WEAPON = CLEAVER_WEAPON + 1,
	BEACH_WEAPON = NEST_WEAPON + 1,
	...
	LABEL_SEWER = LABEL_BUS + 1,
	LAB_MAP = LABEL_SEWER + 1,
	LAB_BACKGROUND_0 = LAB_MAP + 1,
	LAB_BACKGROUND_1 = LAB_BACKGROUND_0 + 1,
	LAB_BACKGROUND_2 = LAB_BACKGROUND_1 + 1,
	LAB_BACKGROUND_3 = LAB_BACKGROUND_2 + 1,
	LAB_BACKGROUND_4 = LAB_BACKGROUND_3 + 1,
	LAB_BACKGROUND_5 = LAB_BACKGROUND_4 + 1,
	LAB_BACKGROUND_6 = LAB_BACKGROUND_5 + 1,
	LAB_BACKGROUND_7 = LAB_BACKGROUND_6 + 1,
	LAB_DECOR_0 = LAB_BACKGROUND_7 + 1,
	LAB_DECOR_1 = LAB_DECOR_0 + 1,
	LAB_OVERLAY = LAB_DECOR_1 + 1,
	LAB_LADDER = LAB_OVERLAY + 1,
	LAB_NPC = LAB_LADDER + 1,
	LAB_WEAPON = LAB_NPC + 1,
	LAB_COLLECT0 = LAB_WEAPON + 1,
	LAB_COLLECT1 = LAB_COLLECT0 + 1,
	LAB_COLLECT2 = LAB_COLLECT1 + 1,
	LAB_COLLECT3 = LAB_COLLECT2 + 1,
	LAB_COLLECT4 = LAB_COLLECT3 + 1,
	...
	CUT_4 = CUT_3 + 1,
    PLAY_BUTTON = CUT_4 + 1,
    MENU_BUTTON = PLAY_BUTTON + 1,
    BACK_BUTTON = MENU_BUTTON + 1,
    RETRY_BUTTON = BACK_BUTTON + 1,
    UBZ_TITLE = RETRY_BUTTON + 1,
    STREET_LVL = UBZ_TITLE + 1,
    LAB_LVL = STREET_LVL + 1,
    BUSLOOP_LVL = LAB_LVL + 1,
    SEWER_LVL = BUSLOOP_LVL + 1,
    WRECK_LVL = SEWER_LVL + 1,
    NEST_LVL = WRECK_LVL + 1,
    MAINMALL_LVL = NEST_LVL + 1,
    IKB_LVL = MAINMALL_LVL + 1,
    BUS_LVL = IKB_LVL + 1,
    FOREST_LVL = BUS_LVL + 1,
	LABEL_LAB = FOREST_LVL + 1,
	NEST_ROOF = LABEL_LAB + 1,
	NEST_DECOR = NEST_ROOF + 1,
	TEXTURE_COUNT = NEST_DECOR + 1
};
